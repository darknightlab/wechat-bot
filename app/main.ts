...
import { ChatBot, OriginalMessage, Conversation, ConversationOptions, JudgeResult, ConversationType } from "./chatbot.js";
...
async function onReady() {
    ...
    chatbot.loadConversation("config/", async (c: Conversation) => {
        if (c.type == "contact") {
...
const MessageTypeMap: Map<number, string> = new Map([
    [0, "unknown"],
    [1, "attachment"],
    [2, "audio"],
    [3, "contact"],
